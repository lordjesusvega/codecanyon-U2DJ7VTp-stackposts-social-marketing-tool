<form>
    ...
    <div class="form-group">
      <label for="status"><?php _e('Menu color')?></label>
      <div>
        <label class="i-radio i-radio--tick i-radio--brand m-r-10">
          <input type="radio" name="appearance_menu_color" <?php _e( get_option('appearance_menu_color', "light")  == "light"?"checked":"" )?> value="light"> <?php _e('Light')?>
          <span></span>
        </label>
        <label class="i-radio i-radio--tick i-radio--brand m-r-10">
          <input type="radio" name="appearance_menu_color" <?php _e( get_option('appearance_menu_color', "dark")  == "dark"?"checked":"" )?> value="dark"> <?php _e('Dark')?>
          <span></span>
        </label>
      </div>
    </div>
