	...
	<div class="m-b-40">
		...
		<div class="alert alert-solid-brand">
	  	...
	  	<div class="form-group">
	        ...
	        <input type="text" class="form-control" id="facebook_login_app_version" name="facebook_login_app_version" value="<?php _e( get_option('facebook_login_app_version', 'v4.0') )?>">
	  	</div>
	</div>
	<div class="m-b-40">
